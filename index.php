        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row justify-content-center gap-2">
                    ...
                    <div class="col-12 col-lg-3 categoryBox1 img-thumbnail align-content-end " style="height: 250px;">
                        <div class="row">
                            <div class="col-12 p-3">
                                <p class="fw-bold text-light fs-4">Tennis Sport</p>
                                <a href="#" class="fw-bold text-light text-decoration-none" style="border-bottom: 2px solid orangered;">Go to category</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-3 categoryBox2 img-thumbnail align-content-end" style="height: 250px;">
                        <div class="row">
                            <div class="col-12 p-3">
                                <p class="fw-bold text-light fs-4">Gymnastic</p>
                                <a href="#" class="fw-bold text-light text-decoration-none" style="border-bottom: 2px solid orangered;">Go to category</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-3 categoryBox3 img-thumbnail align-content-end" style="height: 250px;">
                        <div class="row">
                            <div class="col-12 p-3">
                                <p class="fw-bold text-light fs-4">Cycling</p>
                                <a href="#" class="fw-bold text-light text-decoration-none" style="border-bottom: 2px solid orangered;">Go to category</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-3 categoryBox4 img-thumbnail align-content-end" style="height: 250px;">
                        <div class="row">
                            <div class="col-12 p-3">
                                <p class="fw-bold text-light fs-4">Running</p>
                                <a href="#" class="fw-bold text-light text-decoration-none" style="border-bottom: 2px solid orangered;">Go to category</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 mt-5 mb-3">
                <div class="row">
                    <div class="col-12">
                        <p class="fw-bold fs-3">Most popular products</p>
                    ...
                    <div class="col-12 mt-5" id="lb">
                        <div class="row justify-content-center p-3">
                            <div class="col-4 col-lg-2 d-grid newItem">
                                <button class="btn text-light fw-bold" style="background-color: #fc601d;" onclick="loadMore(4,4);"><i class="bi bi-bag-plus-fill"></i> Load more</button>
                            </div>
                        </div>
                    </div>
